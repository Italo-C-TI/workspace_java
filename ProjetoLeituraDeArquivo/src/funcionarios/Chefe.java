...
public class Chefe extends Funcionario {
	...
	public Chefe(int tipo, int numeroRegistro, String nome, double salarioBase, double adicionalFuncao, double beneficioTerno) {
	...
	public String toString() {
		return tipo+"    ;"+numeroRegistro+"    ;"+nome+"    ;"+salarioBase+"    ;"+adicionalFuncao+"    ;"+beneficioTerno;
	}
